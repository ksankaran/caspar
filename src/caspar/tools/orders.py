# Save as: src/caspar/tools/orders.py
...
class OrderLookupTool:
    ...
    def _generate_mock_orders(self) -> dict[str, OrderInfo]:
        ...
        products = [
            ...
            {"name": "TechFlow Laptop Stand", "price": 49.00, "quantity": 1},
        ]
        ...
        for i in range(20):
            ...
            customer_id = f"CUST-{1000 + (i % 5)}"  # 5 different customers
    ...
    def get_tracking_url(self, tracking_number: str) -> str:
        ...
        # In production, this would link to the actual carrier
