# Save as: src/caspar/tools/tickets.py
...
class TicketTool:
    ...
    def __init__(self):
        # In-memory ticket storage for demo
    ...
    def create(
        ...
        Args:
            ...
            category: Type of issue (return, refund, technical, etc.)
            subject: Brief summary of the issue
            description: Detailed description
            priority: Ticket priority level
            conversation_id: Optional link to the conversation
...
def create_ticket(
    ...
    Returns a dict with ticket info and confirmation message.
    """
